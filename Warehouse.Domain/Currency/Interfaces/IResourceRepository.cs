...
public interface IResourceRepository
{
    ...
    Task<bool> CheckForCreateAsync(string resourceName, CancellationToken cancellationToken = default);
    Task<(Resource? existingResource, bool nameExists)> GetForUpdateCheckAsync(string resourceName, CancellationToken cancellationToken = default);
