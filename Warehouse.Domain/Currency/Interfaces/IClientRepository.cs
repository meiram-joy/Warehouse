...
public interface IClientRepository
{
    ...
    Task<bool> CheckForCreateAsync(string name,string address, CancellationToken cancellationToken);
    Task<(Client? clientToCreate, bool nameExists)> CheckForUpdateAsync(string name,string address, CancellationToken cancellationToken);
